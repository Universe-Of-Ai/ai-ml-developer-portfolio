...
export default function WritePoemPage() {
  ...
  const handleSubmit = async () => {
    if (!body || body === "<p></p>") {
      toast.error("কবিতার বিষয়বস্তু লিখুন");
      return;
    }
    ...
    try {
      ...
      if (data.success) {
        toast.success("কবিতা প্রকাশিত হয়েছে!");
        router.push("/");
      } else {
  ...
  return (
    <div className="max-w-2xl mx-auto">
      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <h1 className="text-lg font-bold">কবিতা লিখুন</h1>
      </div>
      ...
      <div className="space-y-4">
        ...
        <RichTextEditor
          content={body}
          onChange={setBody}
          placeholder="আপনার কবিতা লিখুন... (Enter = নতুন স্তবক, Shift+Enter = একই স্তবকে নতুন লাইন)"
          minRows={10}
        />
        ...
        <div>
          <Input
            placeholder="ট্যাগ (কমা দিয়ে আলাদা করুন, যেমন: ভালোবাসা, প্রকৃতি, জীবন)"
            value={tags}
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 gap-4 p-4 bg-muted/30 rounded-xl">
          ...
          <div className="flex items-center justify-between">
            <Label htmlFor="anon-toggle" className="text-sm cursor-pointer">
              নাম প্রকাশ না করা
            </Label>
            <Switch
              id="anon-toggle"
